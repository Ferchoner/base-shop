...
Además de las dependencias indicadas, cada tarea usa las fundaciones técnicas que le apliquen; en particular, toda operación del staff o evento de seguridad depende de T-127 (auditoría), y todo endpoint de T-113 (errores), T-114 (versionado) y T-126 (rate limiting).
...
| T-230 | Jobs: expiración de reservas y órdenes (cada minuto), conciliación de pagos (cada 5 min); UC-INV-08, UC-ORD-10, UC-PAY-05 | TODO | T-117, T-180, T-190 |
